...
class JobController extends Controller
{
    ...
    function get_jobs() {
      ...
      //  ->join('saves', 'jobs.id', '=', 'saves.job_id')
        ->select('jobs.title as title', 'jobs.pt as pt','jobs.description as description', 'jobs.photo as photo', 'jobs.education as education', 'jobs.salary as salary', 'jobs.province as province', 'jobs.category_id as category_id', 'jobs.created_at as created_at', 'jobs.updated_at as updated_at')
